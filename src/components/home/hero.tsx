...
export function Hero() {
  return (
    <section className="relative flex min-h-[900px] items-center overflow-hidden">
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-16 px-4 py-32 sm:px-6 lg:grid-cols-[1.5fr_1fr] lg:gap-24 lg:px-8 lg:py-40">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          <h1 className="font-heading max-w-3xl text-4xl font-semibold uppercase leading-[1.1] tracking-tight text-white sm:text-5xl xl:text-[55px]">
        ...
        <div className="flex flex-col items-center justify-center text-center lg:items-start lg:justify-center">
          ...
          <a
            ...
            className="mt-5 flex flex-col items-center gap-4 text-[#ffd166] transition-colors hover:text-[#f4c255]"
          >
            <svg
              viewBox="0 0 512 512"
              className="h-32 w-32"
