...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: siteUrl("/movies"), lastModified: new Date(), changeFrequency: "daily", priority: 0.6 },
    { url: siteUrl("/series"), lastModified: new Date(), changeFrequency: "daily", priority: 0.6 },
    ...
    { url: siteUrl("/refund"), lastModified: new Date(), changeFrequency: "yearly", priority: 0.4 },
